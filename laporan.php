...
<head>
    ...
    <style>
        .sidebar { background-color:rgb(84, 6, 218); min-height: 100vh; color: white; }
    ...
    <div class="row">
        ...
        <div class="col-md-3 col-lg-2 sidebar p-0">
            ...
            <ul class="nav flex-column">
                <li class="nav-item">
                    <a class="nav-link" href="index.php"><i class="fas fa-tachometer-alt me-2"></i> isi buku tamu</a></li>
                        ...
                        <table class="table table-striped table-bordered">
                            ...
                            <tbody>
                                <?php if($result && mysqli_num_rows($result) > 0): ?>
                                    ...
                                    <?php endwhile; ?>
                                <?php else: ?>
                                    <tr><td colspan="10" class="text-center">Tidak ada data pengunjung</td></tr>
                                <?php endif; ?>
                            </tbody>
                        </table>
                    </div>
